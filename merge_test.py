...
class TestMergeBom(unittest.TestCase):
    ...
    def test_altiumWorkspace(self):
        ...
        sel.asserEqual(file_BOM, cfg.cfg_altiumWorkspace('./test/utils.DsnWrk', False))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--workspace_file', '-w', 
                        dest='ws', help='Dove si trova il file WorkSpace',
                        default='./test/utils.DsnWrk')
